...
messages[9] = (member, rolesChannel) => `Welcome to the server ${member}! Make sure you go to ${rolesChannel.toString()} and choose the roles you would like to have (also choose the classes you’re in)`;
...
messages[14] = (member, rolesChannel) => `${member} welcome! what class are you in? might want to check out 🟨-hpe-dsi-101-🟨  if that's your course. Please go to ${rolesChannel.toString()} and make sure to sign up for notifications in your classes!`;
